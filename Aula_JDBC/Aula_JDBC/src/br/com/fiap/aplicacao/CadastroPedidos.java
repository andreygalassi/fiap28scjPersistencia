	...
	public static void main(String[] args) {
		...
		while (true) {
			try {
				...
				double valor = parseDouble(showInputDialog("Informe o valor:"));

				Clientes cliente = (Clientes) showInputDialog(
														null,
														"Selecione o cliente",
														"Clientes",
														DEFAULT_OPTION,
			...
			int opcao = showConfirmDialog(null, "Deseja continuar incluindo pedidos?"
